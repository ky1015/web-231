...
// declare htmlCode variable with a blank string value
let htmlCode = "";

// create a for loop to loop through captions and add images
// for loop syntax: for (let i=0; i < objects.length; i++), use += to concatenate strings
//slidei.jpg is an unexpected value, need to separate out i from slide.jpg
...
// use innerHTML to change element with id of gallery to the value of htmlCode variable
